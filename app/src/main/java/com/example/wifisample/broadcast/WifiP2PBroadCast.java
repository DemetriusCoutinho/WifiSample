...
public class WifiP2PBroadCast extends BroadcastReceiver {
    ...
    public WifiP2PBroadCast(WifiP2pManager mWifiP2pManager, WifiP2pManager.Channel mChannel, MainActivity mMainActivity, WifiP2pManager.PeerListListener peerListListener) {
